...
If you want the see the Arduino part click here: [Clinostat3D-Esp32]([https://github.com/carloterzaghi/Clinostat3D-Arduino](https://github.com/carloterzaghi/Clinostat3D-Esp32))
<br><br>
# How to install
